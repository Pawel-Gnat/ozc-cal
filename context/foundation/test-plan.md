...
|---|------------|-----------------|---------------|------------|--------|---------------|
| 1 | Calculation core + test bootstrap | Bootstrap Vitest and prove WT 2021 engine correctness + repeatability with reference cases | #1, #6 | unit + runner setup | change opened | testing-calculation-core-test-bootstrap |
...
|-------|------|---------|-------|
| unit + integration | Vitest | TBD | none yet — see §3 Phase 1; Astro 6 supports `getViteConfig()` per official docs |
...
- Docs: Context7 (`/withastro/docs`, `/vitest-dev/vitest`) — Astro 6 Vitest setup via `getViteConfig()`; checked: 2026-06-15
...
- TBD — see §3 Phase 1 for WT 2021 reference-case pattern.
...
(Optional — filled after each phase lands.)
