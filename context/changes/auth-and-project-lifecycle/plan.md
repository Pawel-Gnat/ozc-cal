...
- [ ] 3.3 Dashboard lists projects and shows empty state
- [ ] 3.4 Project detail placeholder renders; invalid/forbidden ID redirects with error
- [ ] 3.5 Two-user RLS isolation verified manually
