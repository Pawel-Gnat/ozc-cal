...
- [x] 2.1 Linting passes: `npm run lint` — 6fcc54a
- [x] 2.2 Build passes with pdf.js worker asset: `npm run build` — 6fcc54a

#### Manual

- [x] 2.3 Editor page loads PDF; pan/zoom works smoothly — 6fcc54a
- [x] 2.4 Prerequisites redirect with clear error when climate, assemblies, or PDF missing — 6fcc54a
- [x] 2.5 Scale calibration completes and persists across reload; draw tools disabled until scale set — 6fcc54a

### Phase 3: Drawing & Geometry

#### Automated

- [x] 3.1 Linting passes: `npm run lint` — 1d97487
- [x] 3.2 Build passes: `npm run build` — 1d97487

#### Manual

- [x] 3.3 Draw H/V segments with endpoint snap; diagonals rejected — 1d97487
- [x] 3.4 Segments require assembly assignment; reload restores correctly — 1d97487
- [x] 3.5 Auto-save debounces rapid draws; delete segment persists — 1d97487

### Phase 4: Rooms & Ventilation

#### Automated

- [x] 4.1 Migration still applies: `npx supabase db reset --no-seed` — 3afcb99
- [x] 4.2 Linting passes: `npm run lint` — 3afcb99
- [x] 4.3 Build passes: `npm run build` — 3afcb99

#### Manual

- [x] 4.4 Auto-detected room with temp and ventilation saves and reloads — 3afcb99
- [x] 4.5 Manual room creation works when auto-detect not offered — 3afcb99
- [x] 4.6 Room without internal temp rejected by validation — 3afcb99

### Phase 5: Integration & Verification

#### Automated

- [x] 5.1 Linting passes: `npm run lint` — acde84c
- [x] 5.2 Build passes: `npm run build` — acde84c

#### Manual

- [x] 5.3 End-to-end FR-006–008 walkthrough on typical PDF — acde84c
- [x] 5.4 Second user isolation on editor page and APIs — acde84c
- [x] 5.5 Editor readable/usable at reasonable zoom on typical architectural PDF — acde84c
