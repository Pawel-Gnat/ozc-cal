...
- [x] 2.1 Linting passes: `npm run lint` — e317b29
- [x] 2.2 Build passes: `npm run build` — e317b29
...
- [x] 3.1 Linting passes: `npm run lint` — fad1373
- [x] 3.2 Build passes: `npm run build` — fad1373
