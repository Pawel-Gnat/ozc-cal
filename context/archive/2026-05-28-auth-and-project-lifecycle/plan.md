...
- [x] 4.1 Linting passes: `npm run lint` — 17be347
- [x] 4.2 Production build passes: `npm run build` — 17be347

#### Manual

- [x] 4.3 FR-001 through FR-003 end-to-end manual checklist passes — 17be347
